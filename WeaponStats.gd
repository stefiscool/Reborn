...
func _process(_delta):
	if not Global.flamecharged:
		...
		var second_weapons = {
			...
			"Supercharged Crossbow": {"rateoffire": 0.8, "damage": 280, "maxammo": 1, "bulletvelocity": 1800, "element": "Shock", "zoom": 1.5, "description": "A bandit crossbow with electrically charged bolts that can paralyze enemies. Ideal for medium-range engagements."},
		...
		var armors = {
			...
			"Bandit Light Armor": {"speed": 245, "defaultdefense": 1.5, "maxhealth": 70, "maxshields": 50, "shieldcooldown": 8, "shieldregen": 2, "armordescription": "Lightweight armor favored by bandits for quick getaways. Offers minimal protection."},
			"Bandit Medium Armor": {"speed": 220, "defaultdefense": 1.6, "maxhealth": 80, "maxshields": 50, "shieldcooldown": 9, "shieldregen": 1, "armordescription": "A balanced armor used by bandits, providing decent mobility and moderate protection."},
			"Bandit Heavy Armor": {"speed": 205, "defaultdefense": 1.8, "maxhealth": 110, "maxshields": 40, "shieldcooldown": 10, "shieldregen": 1, "armordescription": "Bulky armor used by juggernaut bandits. It offers significant protection at the cost of reduced speed."},
		...
		var spaceships = {
			"Assault Fighter": {"shipname": "Assault Fighter", "shiphealth": 1200, "shipspeed": 4500, "shipweapon": "Plasma Cannons", "shipweapondamage": 120, "shipfirerate": 0.33, "shipspecial": "Missile Barrage", "shipspecialdamage": 1800, "shipspecialcooldown": 25, "shipdescription": "A heavily armored fighter designed for frontline assaults. Equipped with powerful plasma cannons and a devastating missile barrage system."},
			"Bandit Attacker": {"shipname": "Bandit Attacker", "shiphealth": 800, "shipspeed": 5200, "shipweapon": "Rapid Blasters", "shipweapondamage": 80, "shipfirerate": 0.2, "shipspecial": "EMP Pulse", "shipspecialdamage": 1500, "shipspecialcooldown": 15, "shipdescription": "A swift raider vessel favored by space bandits. Features rapid-fire blasters and an EMP pulse system for disabling enemy ships."},
			"Bandit Fighter": {"shipname": "Bandit Fighter", "shiphealth": 900, "shipspeed": 5000, "shipweapon": "Kinetic Cannons", "shipweapondamage": 90, "shipfirerate": 0.3, "shipspecial": "Scrap Bomb", "shipspecialdamage": 1700, "shipspecialcooldown": 18, "shipdescription": "A versatile combat vessel used by bandit squadrons. Balanced speed and firepower with improvised but effective weapons systems."},
			"Bandit Heavy Attacker": {"shipname": "Bandit Heavy Attacker", "shiphealth": 1500, "shipspeed": 4000, "shipweapon": "Heavy Cannons", "shipweapondamage": 150, "shipfirerate": 0.5, "shipspecial": "Shockwave", "shipspecialdamage": 2200, "shipspecialcooldown": 30, "shipdescription": "A reinforced bandit vessel built for heavy assault. Sacrifices speed for superior armor and devastating weapon systems."},
			"Fighter-Bomber": {"shipname": "Fighter-Bomber", "shiphealth": 1100, "shipspeed": 4800, "shipweapon": "Heavy Lasers", "shipweapondamage": 110, "shipfirerate": 0.375, "shipspecial": "Napalm Bomb", "shipspecialdamage": 2500, "shipspecialcooldown": 28, "shipdescription": "A versatile republic ship designed for both dogfighting and bombing runs. Features dual cannons and high-yield thermal detonators."},
			"Interceptor": {"shipname": "Interceptor", "shiphealth": 700, "shipspeed": 6000, "shipweapon": "Precision Lasers", "shipweapondamage": 95, "shipfirerate": 0.27, "shipspecial": "Afterburner", "shipspecialdamage": 1200, "shipspecialcooldown": 12, "shipdescription": "An extremely fast republic ship designed to intercept enemy vessels. Features precision targeting systems and a powerful afterburner for quick maneuvers."},
			"Starfighter": {"shipname": "Starfighter", "shiphealth": 500, "shipspeed": 5000, "shipweapon": "Ion Cannons", "shipweapondamage": 50, "shipfirerate": 0.33, "shipspecial": "Ion Bomb", "shipspecialdamage": 2000, "shipspecialcooldown": 20, "shipdescription": "A balanced republic fighter craft with reliable laser weaponry and ion bomb capability. The standard vessel for republic space forces."}
		}
