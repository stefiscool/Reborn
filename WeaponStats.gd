...
func _process(_delta):
	if not Global.flamecharged:
		...
		var armors = {
			...
			"Bandit Light Armor": {"speed": 245, "defaultdefense": 1.5, "maxhealth": 70, "maxshields": 50, "shieldcooldown": 8, "shieldregen": 4, "armordescription": "Lightweight armor favored by bandits for quick getaways. Offers minimal protection."},
