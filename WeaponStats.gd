...
func _process(_delta):
	if not Global.flamecharged:
		...
		var second_weapons = {
			...
			"Void Supercannon": {"rateoffire": 1.2, "damage": 120, "maxammo": 4, "bulletvelocity": 2000, "element": "Void", "zoom": 1.5, "description": "A heavy, high-powered weapon with a massive damage output. Suitable for long-range destruction."},
			...
			"A-70 Shotgun": {"rateoffire": 0.1, "damage": 65, "maxammo": 12, "bulletvelocity": 1350, "element": "Kinetic(Sh)", "zoom": 1.8, "description": "A semi-automatic shotgun designed for medium-range combat, dealing massive damage in a short burst."},
			"RPG-30": {"rateoffire": 1.2, "damage": 200, "maxammo": 1, "bulletvelocity": 1250, "element": "Explosive", "zoom": 1.2, "description": "A powerful anti-tank rocket-propelled grenade launcher with high damage, designed to penetrate heavily armored vehicles."},
