...
func _process(_delta):
	if not Global.flamecharged:
		var weapons = {
			...
			"ARC-20": {"rateoffire": 0.07, "damage": 38, "maxammo": 30, "bulletvelocity": 1750, "element": "Kinetic", "zoom": 1.7, "description": "A lightweight, adaptable rifle with a smooth firing rate. Suitable for versatile combat scenarios."},
			"M2000": {"rateoffire": 0.05, "damage": 28, "maxammo": 100, "bulletvelocity": 1650, "element": "Kinetic(MG)", "zoom": 1.8, "description": "A light machine gun with a high rate of fire and large magazine, ideal for suppressive fire."},
			"S-TAR": {"rateoffire": 0.06, "damage": 25, "maxammo": 32, "bulletvelocity": 1400, "element": "Kinetic", "zoom": 2, "description": "A submachine gun with a fast firing rate and compact design, excellent for urban combat."},
			...
			"XR-50": {"rateoffire": 0.05, "damage": 40, "maxammo": 25, "bulletvelocity": 1950, "element": "Kinetic", "zoom": 1.5, "description": "A cutting-edge rifle with high damage and precision, built for the modern battlefield."}
}
		...
		var second_weapons = {
			...
			"Deagle": {"rateoffire": 0.3, "damage": 90, "maxammo": 7, "bulletvelocity": 1600, "element": "Kinetic(Sn)", "zoom": 2.0, "description": "A high-caliber pistol with exceptional damage. Perfect for taking down enemies with a few well-placed shots."},
			"Trench Shotgun": {"rateoffire": 0.8, "damage": 60, "maxammo": 6, "bulletvelocity": 1200, "element": "Kinetic(Sh)", "zoom": 1.9, "description": "A close-range shotgun with a wide spread. Perfect for clearing out enemies in tight spaces."},
			"Void Supercannon": {"rateoffire": 1.5, "damage": 120, "maxammo": 4, "bulletvelocity": 2000, "element": "Void", "zoom": 1.5, "description": "A heavy, high-powered weapon with a massive damage output. Suitable for long-range destruction."},
			"A-10 Shotgun": {"rateoffire": 0.7, "damage": 55, "maxammo": 8, "bulletvelocity": 1200, "element": "Kinetic(Sh)", "zoom": 1.9, "description": "A powerful shotgun with a moderate rate of fire, designed for clearing out groups of enemies."},
			"White Feather Sniper": {"rateoffire": 1.0, "damage": 90, "maxammo": 5, "bulletvelocity": 2500, "element": "Kinetic(Sn)", "zoom": 1.0, "description": "A high-precision sniper rifle, perfect for taking out enemies at long range with devastating shots."},
			"Supercharged Crossbow": {"rateoffire": 0.9, "damage": 70, "maxammo": 1, "bulletvelocity": 1800, "element": "Shock", "zoom": 1.5, "description": "A crossbow with electrically charged bolts that can paralyze enemies. Ideal for medium-range engagements."},
			"Shock Cannon": {"rateoffire": 1.2, "damage": 80, "maxammo": 6, "bulletvelocity": 1000, "element": "Shock", "zoom": 2.0, "description": "A cannon that fires high-voltage projectiles, causing electric shock damage."},
			"A-70 Shotgun": {"rateoffire": 0.1, "damage": 65, "maxammo": 12, "bulletvelocity": 1350, "element": "Kinetic(SeSh)", "zoom": 1.8, "description": "A semi-automatic shotgun designed for medium-range combat, dealing massive damage in a short burst."},
			"RPG-30": {"rateoffire": 1.5, "damage": 200, "maxammo": 1, "bulletvelocity": 1250, "element": "Explosive", "zoom": 1.2, "description": "A powerful anti-tank rocket-propelled grenade launcher with high damage, designed to penetrate heavily armored vehicles."},
			"AT-10 Antitank Rifle": {"rateoffire": 1.3, "damage": 150, "maxammo": 4, "bulletvelocity": 2800, "element": "Kinetic(AT)", "zoom": 1.1, "description": "A powerful antitank rifle capable of piercing heavy armor. Effective against vehicles and heavily armored enemies."},
			"P-10 Pistol": {"rateoffire": 0.05, "damage": 35, "maxammo": 12, "bulletvelocity": 1600, "element": "Kinetic", "zoom": 2.0, "description": "A reliable and compact pistol with moderate damage and accuracy, ideal for backup."},
			"Laser Pistol": {"rateoffire": 0.15, "damage": 45, "maxammo": 10, "bulletvelocity": 2200, "element": "Laser", "zoom": 1.8, "description": "A futuristic pistol that fires high-energy laser bolts. Excellent for high-accuracy, medium-range engagements."},
			"P-20 Supressed Pistol": {"rateoffire": 0.25, "damage": 40, "maxammo": 15, "bulletvelocity": 1700, "element": "Kinetic(Su)", "zoom": 2.0, "description": "A silenced pistol for stealthy operations. Ideal for eliminating enemies quietly in close combat."},
		...
		var armors = {
			...
			"Bandit Heavy Armor": {"speed": 210, "defaultdefense": 2, "maxhealth": 120, "maxshields": 90, "shieldcooldown": 12, "shieldregen": 0, "armordescription": "Bulky armor used by juggernaut bandits. It offers significant protection at the cost of reduced speed."},
			"Shock Robe": {"speed": 230, "defaultdefense": 1, "maxhealth": 70, "maxshields": 120, "shieldcooldown": 7, "shieldregen": 2, "armordescription": "An electrified robe that enhances shield capabilities, ideal for hit-and-run tactics."},
			"Void Robe": {"speed": 220, "defaultdefense": 1, "maxhealth": 60, "maxshields": 150, "shieldcooldown": 6, "shieldregen": 3, "armordescription": "A mysterious robe infused with void energy, maximizing shields but sacrificing health."},
			"Marine Armor": {"speed": 215, "defaultdefense": 2, "maxhealth": 120, "maxshields": 100, "shieldcooldown": 8, "shieldregen": 1, "armordescription": "A durable armor for republic marines, providing balanced health and shield capabilities."},
			...
			"Reborn Knight Armor": {"speed": 210, "defaultdefense": 2, "maxhealth": 140, "maxshields": 120, "shieldcooldown": 12, "shieldregen": 0, "armordescription": "Heavy armor for chosen Reborn Knights, prioritizing defense and durability over mobility."}
		}
