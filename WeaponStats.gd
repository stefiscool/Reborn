...
func _process(_delta):
	if not Global.flamecharged:
		...
		var armors = {
			...
			"Cyber Armor": {"speed": 180, "defaultdefense": 1, "maxhealth": 60, "maxshields": 150, "shieldcooldown": 5, "shieldregen": 3, "armordescription": "Advanced armor with superior shield capacity and regeneration, offset by reduced health and speed due to all of the clunky cybernetic parts."},
			"Bandit Light Armor": {"speed": 240, "defaultdefense": 1, "maxhealth": 80, "maxshields": 50, "shieldcooldown": 9, "shieldregen": 1, "armordescription": "Lightweight armor favored by bandits for quick getaways. Offers minimal protection."},
			...
			"Bandit Heavy Armor": {"speed": 190, "defaultdefense": 1.2, "maxhealth": 120, "maxshields": 90, "shieldcooldown": 12, "shieldregen": 0, "armordescription": "Bulky armor used by juggernaut bandits. It offers significant protection at the cost of reduced speed and no regen."},
			"Shock Robe": {"speed": 230, "defaultdefense": 1, "maxhealth": 50, "maxshields": 120, "shieldcooldown": 10, "shieldregen": 4, "armordescription": "An electrified robe that enhances shield capabilities, ideal for hit-and-run tactics. Once the shield is gone, good luck."},
			"Void Robe": {"speed": 220, "defaultdefense": 1, "maxhealth": 40, "maxshields": 160, "shieldcooldown": 17, "shieldregen": 6, "armordescription": "A mysterious robe infused with void energy, maximizing shields but sacrificing health. Very fast regeneration."},
			...
			"Reborn Squire Armor": {"speed": 250, "defaultdefense": 1, "maxhealth": 90, "maxshields": 60, "shieldcooldown": 6, "shieldregen": 3, "armordescription": "A lightweight armor for aspiring Reborn Knights, offering good mobility. It has a weak shield, but it regenerates fast."},
			"Reborn Knight Armor": {"speed": 200, "defaultdefense": 1.2, "maxhealth": 140, "maxshields": 120, "shieldcooldown": 12, "shieldregen": 0, "armordescription": "Heavy armor for chosen Reborn Knights, prioritizing defense and durability over mobility and regen."}
		}
