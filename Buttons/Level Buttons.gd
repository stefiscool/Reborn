...
var missions = {
	...
	6: { "name": "Tokyo", "desc": "The once-thriving megacity is now ruled by a cyber-enhanced warlord. In order to get through his base, you need to get through his anti-air defenses. When you get there, blow up the main console that controls the robot army's mass tactics and communication." },
