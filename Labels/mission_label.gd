...
func _process(_delta):
	var mission_texts = {
		...
		3: "Retrieve vital intel from the city's central tower (%s/%s)",
		4: "Survive the harsh tundra and recover the energy cores",
		5: "Unearth the hidden base and shut down illegal operations (%s/%s)",
